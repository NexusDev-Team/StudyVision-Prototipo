...
// marcadores ("- " no início da linha, "1. " para etapas, linha SÓ
...
const SUMMARY_FORMATTING = `Formatação — vale APENAS para o texto do campo "summary", em nenhum outro campo:
  ...
  - Nunca junte rótulo e texto na mesma linha; nunca use "-" ou número no meio de
    uma frase corrida.
  - NUNCA use listas numeradas ("1. ", "2. ", ...) para apresentar etapas de um
    processo. Etapa de processo é subtítulo isolado ("Etapa 1:", "Etapa 2:", ...),
    cada uma seguida do próprio parágrafo curto — nunca um item de lista.
...
export const PREFERENCE_RULES = {
  ...
  em etapas, cada uma como bloco PRÓPRIO e isolado — subtítulo curto ("Etapa 1:",
  "Etapa 2:", ...) seguido de um parágrafo curto. NUNCA apresente as etapas como
  uma lista numerada compacta: isso empilha tudo de novo, o exato problema que
  esta necessidade existe para evitar. Em cada etapa, separe claramente a ação, o
  porquê e o resultado parcial. Não entregue a resolução inteira de uma vez.
  Preserve TODAS as etapas — nenhuma é pulada para encurtar.`,
};
