...
// semanal que não é. Uma barra por nível, proporcional à contagem.
export default function PerformanceChart({ breakdown = {}, hasActivity = false, locked, onStartTrial }) {
  const total = ORDER.reduce((sum, k) => sum + (breakdown[k] || 0), 0);

  return (
    <div style={{ marginBottom: 20 }}>
      <SectionLabel>Distribuição de domínio</SectionLabel>
      <PlusPaywall locked={locked} title="Ver análise detalhada" message="Acompanhe quantos conteúdos você já domina." onStartTrial={onStartTrial}>
